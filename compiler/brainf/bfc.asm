...
;jmp start
;db 0xE9,0x1A,0x00
mov bx,start_functions_end-start_functions+program_location
jmp bx
...
mov ax,0xBB51
stosw
mov ax,program_location+output-start_functions
stosw
...
mov ax,0xBB51
stosw
mov ax,program_location+input-start_functions
stosw
...
mov [find_loop.char_found],al
call find_loop
jmp .loop	; Skip the loop
jmp bx
...
.found:
cmp al,[find_loop.char_found]
jne .opposite
inc word [.loop_count]
jmp .loop
.opposite:
cmp word [.loop_count],0
je .end
dec word [.loop_count]
jmp .loop
.end:
...
infile:	times 15 db 0
outfile:times 15 db 0
